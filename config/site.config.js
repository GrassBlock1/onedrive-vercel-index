...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'me@imgb.ml',
  ...
  title:"GrassBlock's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/od_public',
  ...
  links: [
    ...
    {
      name: 'Telegram',
      link: 'https://t.me/realGrassblock',
    },
    {
      name: 'Mastodon',
      link: 'https://o3o.ca/@grassblock',
    }
  ],
